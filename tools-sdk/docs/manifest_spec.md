...
| `home_icon` | **string** | Ícone geométrico do card na Home. Um de: `card` (padrão), `dice`, `spin`, `coin`, `triangle`, `bingo`, `order`, `timer`, `first`, `teams`, `ask`, `pavio`, `adedonha`, `placar`, `veto`, `mimica`, `testa`, `phone`, `estouro`, `dial`. | `"dice"` |
