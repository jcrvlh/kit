...
static esp_err_t panel_co5300_draw_bitmap(esp_lcd_panel_t *panel, int x_start, int y_start, int x_end, int y_end, const void *color_data)
{
    ...
    // o enfileiramento falha (disputa de barramento com o Wi-Fi), o callback de
    // "trans done" nunca vem e o LVGL trava pra sempre em wait_for_flushing()
    // — e quem chama não tem como saber. Ver README.KIT.md.
