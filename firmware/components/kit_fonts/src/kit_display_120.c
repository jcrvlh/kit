 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --format lvgl --force-fast-kern-format --size 120 --font ArchivoBlack-Regular.ttf -r 0x2B,0x2D,0x30-0x39 -o kit_display_120.c
 ******************************************************************************/
